            ...
            <div id="activities-container">
                <div class="activity-item">
                    ...
                    <div class="col-6 col-sm-2">
                            <?= $form->field($actividadModel, 'empleado_id[]')->input('text') ?>
                        </div>
                        <div class="col-6 col-sm-2">
...
$("#add-activity").on("click", function () {
    var newActivity = `<div class="activity-item">
        ...
        <div class="row">
         <div class="col-6 col-sm-2">
                <div class="form-group field-reporte-extra-empleado_id">
                    <input type="text" class="form-control" name="ActividadReporteTiempoExtraGeneral[empleado_id][]" />
                </div>
            </div>
            <div class="col-6 col-sm-2">
