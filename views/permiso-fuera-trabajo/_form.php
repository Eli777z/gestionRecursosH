        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-header bg-info text-white">
                    ...
                    <?php //SE OBTIENE EL USUARIO ACTIVO
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <p><strong>Permisos usados:</strong> <?= $permisosUsados //MUESTRA LA CANTIDAD DE PERMISOS QUE HA SOLICITDAD
                                                                    ?></p>
                            <p><strong>Permisos disponibles:</strong> <?= $permisosDisponibles //MUESTRA LOS PERMISOS DISPONIBLES
                                                                        ?></p>
                        </div>
                                ...
                                <div class="card bg-light">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <?= $form->field($motivoFechaPermisoModel, 'motivo')->widget(FroalaEditorWidget::className(), [//WIDGEET PARA TRANSFORMAR EL INPUT EN UN INPUT CON EDITOR DE TEXTO
                                                'options' => [
                                                    'id' => 'exp-fisca'
                                                ],
                                                'clientOptions' => [
