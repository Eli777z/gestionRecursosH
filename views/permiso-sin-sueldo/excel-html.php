...
$this->title = 'Permiso_Sin_Goce_Sueldo_'.$model->empleado->nombre.' '.$model->empleado->apellido;
...
<style>
    @media print {
        ...
        .print-area {
            ...
            width: 200%;
            max-height: 100%;
            transform: scale(1.30); /* Escalar el contenido al 75% */
...
<?= Html::a('<i class="fa fa-print" aria-hidden="true"></i> Imprimir', '#', ['class' => 'btn btn-primary no-print floating-btn', 'onclick' => 'window.print(); return false;']) ?>
