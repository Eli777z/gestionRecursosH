var municipios = {
            ...
            // ... (tus datos de estados y municipios en formato adecuado) ...

$(document).ready(function() {
    // Llenar el dropdown de estados
    var estados = Object.keys(municipios); // Asumiendo que 'municipios' es un objeto donde las claves son los estados
    var $estadoDropdown = $('#estado-dropdown');
    $estadoDropdown.append($('<option value="">Selecciona un estado</option>'));
    $.each(estados, function(index, estado) {
        $estadoDropdown.append($('<option value="' + estado + '">' + estado + '</option>'));
    });

    // Manejar el cambio de estado
    $estadoDropdown.change(function() {
        var estadoSeleccionado = $(this).val();
        var municipiosDelEstado = municipios[estadoSeleccionado];
        var $municipioDropdown = $('#municipio-dropdown');
        $municipioDropdown.empty();
        $municipioDropdown.append($('<option value="">Selecciona un municipio</option>'));
        $.each(municipiosDelEstado, function(index, municipio) {
            $municipioDropdown.append($('<option value="' + municipio + '">' + municipio + '</option>'));
        });
    });
});
