        ...
        <div class="row">
            <div class="col-6 col-sm-2">
                <div class="form-group field-reporte-extra-fecha">
                    <input type="date" class="form-control" name="ActividadReporteTiempoExtra[fecha][]" />
                </div>
            </div>
            <div class="col-6 col-sm-2">
                <div class="form-group field-reporte-extra-horario_inicio">
                    <input type="time" class="form-control horario-inicio" name="ActividadReporteTiempoExtra[hora_inicio][]" />
                </div>
            </div>
            <div class="col-6 col-sm-2">
                <div class="form-group field-reporte-extra-horario_fin">
                    <input type="time" class="form-control horario-fin" name="ActividadReporteTiempoExtra[hora_fin][]" />
                    <input type="hidden" class="no-horas" name="ActividadReporteTiempoExtra[no_horas][]" readonly />
                </div>
            </div>
            <div class="col-6 col-sm-4">
                <div class="form-group field-reporte-extra-actividad">
                    <textarea class="form-control" rows="2" name="ActividadReporteTiempoExtra[actividad][]"></textarea>
                </div>
            </div>
