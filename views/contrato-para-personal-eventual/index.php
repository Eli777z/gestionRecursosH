...
/* @var $searchModel app\models\ContratoParaPersonalEventualSearch */
...
<div class="col-md-10">
            ...
            <h3>Historial de Solicitud de contrato para personal eventual</h3>
...
<?= GridView::widget([
    ...
    'columns' => [
        ...
        [
            ...
            'attribute' => 'numero_contrato',
            'format' => 'html',
            'value' => function ($model) {
                return \yii\helpers\Html::decode($model->numero_contrato);
            },
            'filter' => false,
