...
/**
 * This is the model class for table "segundo_periodo_vacacional".
 *
 * @property int $id
 ...
 */
class SegundoPeriodoVacacional extends \yii\db\ActiveRecord
{
    public $dateRange;
    ...
    {
        return 'segundo_periodo_vacacional';
    }
    ...
    {
        return $this->hasMany(Vacaciones::class, ['segundo_periodo_vacacional_id' => 'id']);
    }
