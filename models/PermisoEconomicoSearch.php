...
/**
 * PermisoEconomicoSearch represents the model behind the search form of `app\models\PermisoEconomico`.
 */
class PermisoEconomicoSearch extends PermisoEconomico
{
    /**
     * {@inheritdoc}
     */
