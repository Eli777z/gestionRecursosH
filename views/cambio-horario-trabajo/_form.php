        ...
        <div class="col-md-10">
            ...
            <?php $form = ActiveForm::begin(); ?>
                <div class="card-header bg-primary text-white">
                    <h2>CREAR NUEVA SOLICITUD DE HORARIO DE TRABAJO</h2>
...
<div class="card">
   ...
   <?= $form->field($model, 'turno')->dropDownList(
    ...
    <?= $form->field($model, 'horario_inicio')->widget(TimePicker::classname(), [
    'pluginOptions' => [
        'showMeridian' => true, 
        'minuteStep' => 1,
        'defaultTime' => false,
...
<?= $form->field($model, 'horario_fin')->widget(TimePicker::classname(), [
    'pluginOptions' => [
        'showMeridian' => true, 
        'minuteStep' => 1,
        'defaultTime' => false,
    ]
])->label('Termino de horario') ?>
