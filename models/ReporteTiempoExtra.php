...
/**
 * This is the model class for table "reporte_tiempo_extra".
 *
 * @property int $id
 ...
 *
 * @property ActividadReporteTiempoExtra[] $actividadReporteTiempoExtras
 * @property Empleado $empleado
 * @property Solicitud $solicitud
 */
class ReporteTiempoExtra extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Gets query for [[ActividadReporteTiempoExtras]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getActividadReporteTiempoExtras()
    {
        return $this->hasMany(ActividadReporteTiempoExtra::class, ['reporte_tiempo_extra_id' => 'id']);
    }
